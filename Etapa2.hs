...
Replit: https://replit.com/@Tiagodpa/Etapa-2-Bomberman#main.hs
...
moveloop (tab, j) = 
          do
            ...
            n <- jogadorVez
            if n > 0 && n < 5 then print(infoJogadores n j)
            else moveloop (tab, j)
            op <- menu
...
mudarTabuleiro (x,y) c (l0,l1,l2,l3,l4,l5,l6,l7)
                                              ...
                                              | c == 'N' = (l0,l1,l2,l3,l4,l5,l6,l7)
                                              | c == 'b' = (l0,l1,l2,l3,l4,l5,l6,l7)
